...
namespace Xervizio {
    ...
    public static class StringExtensions {
        ...
        public static void ShouldNotBeEmpty(this string value, string argName = "argument") {
            string errorMessage = "{0} should not be empty.".WithTokens(argName);
            Protect.Against<ArgumentException>(string.IsNullOrEmpty(value), errorMessage);
            Protect.AgainstInvalidOperation(string.IsNullOrWhiteSpace(value), errorMessage);
        }

        public static TInstance ToInstanceOf<TInstance>(this string json) where TInstance : class {
            return JsonConvert.DeserializeObject<TInstance>(json);
        }

        public static string[] Split(this string input, params char[] delimiters) {
        ...
        public static string Truncate(this string str, int maxLength) {
            ...
            return str; // does not exceed the maxLength
        }
        ...
        /// </remarks>
        public static string EscapeUriStringRfc3986(this string value) {
